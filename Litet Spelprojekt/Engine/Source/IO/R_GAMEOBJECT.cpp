...
void GAMEOBJECT::RegisterResources()
{
	...
	BED_BUNK					= ResourceHandler::RegisterGameObject("Bunk Bed", MESH::BED_BUNK, MATERIAL::WHITE);
	BED_SINGLE					= ResourceHandler::RegisterGameObject("Single Bed", MESH::BED_SINGLE, MATERIAL::WHITE);
