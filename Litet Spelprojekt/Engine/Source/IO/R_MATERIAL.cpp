...
void MATERIAL::RegisterResources()
{
	...
	OCEAN_BLUE			= ResourceHandler::RegisterMaterial(glm::vec4(0.09f, 0.34f, 0.49f, 1.0f)	, 256.0f, -1, SHADER::DEFERRED_MATERIAL);
	...
	WALL_STANDARD		= ResourceHandler::RegisterWallMaterial(glm::vec4(1.0f, 1.0f, 0.0f, 1.0f)	, 256.0f, -1);
