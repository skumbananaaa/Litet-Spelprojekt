...
uint32 MATERIAL::ANIMATED_MODEL_EXTINGUISH = 0;
...
uint32 MATERIAL::FLOOR_EXT_NORMAL = 0;
uint32 MATERIAL::FLOOR_EXT_SICKBAY1 = 0;
uint32 MATERIAL::FLOOR_EXT_TOILET1 = 0;
uint32 MATERIAL::FLOOR_EXT_MACHINE1 = 0;
uint32 MATERIAL::FLOOR_EXT_MACHINE2 = 0;
uint32 MATERIAL::FLOOR_EXT_MACHINE3 = 0;
uint32 MATERIAL::FLOOR_EXT_AMMUNITION1 = 0;
uint32 MATERIAL::FLOOR_EXT_AMMUNITION2 = 0;
uint32 MATERIAL::FLOOR_EXT_AMMUNITION3 = 0;
uint32 MATERIAL::FLOOR_EXT_KITCHEN1 = 0;
uint32 MATERIAL::FLOOR_EXT_DINING1 = 0;
uint32 MATERIAL::FLOOR_EXT_CABOOSE1 = 0;
...
void MATERIAL::RegisterResources()
{
	...
	ANIMATED_MODEL_EXTINGUISH	= ResourceHandler::RegisterMaterial(TEXTURE::SJOFAN_DIFF_EXTINGUISH, SHADER::ANIMATION);
	...
	FLOOR_EXT_SICKBAY1			= ResourceHandler::RegisterMaterial(TEXTURE::FLOOR_EXT_SICKBAY1, SHADER::FLOOR);
	FLOOR_EXT_TOILET1			= ResourceHandler::RegisterMaterial(TEXTURE::FLOOR_EXT_TOILET1, SHADER::FLOOR);
	FLOOR_EXT_MACHINE1			= ResourceHandler::RegisterMaterial(TEXTURE::FLOOR_EXT_MACHINE1, SHADER::FLOOR);
	FLOOR_EXT_MACHINE2			= ResourceHandler::RegisterMaterial(TEXTURE::FLOOR_EXT_MACHINE2, SHADER::FLOOR);
	FLOOR_EXT_AMMUNITION1		= ResourceHandler::RegisterMaterial(TEXTURE::FLOOR_EXT_AMMUNITION1, SHADER::FLOOR);
	FLOOR_EXT_MACHINE3			= ResourceHandler::RegisterMaterial(TEXTURE::FLOOR_EXT_MACHINE3, SHADER::FLOOR);
	FLOOR_EXT_AMMUNITION2		= ResourceHandler::RegisterMaterial(TEXTURE::FLOOR_EXT_AMMUNITION2, SHADER::FLOOR);
	FLOOR_EXT_AMMUNITION3		= ResourceHandler::RegisterMaterial(TEXTURE::FLOOR_EXT_AMMUNITION3, SHADER::FLOOR);
	FLOOR_EXT_KITCHEN1			= ResourceHandler::RegisterMaterial(TEXTURE::FLOOR_EXT_KITCHEN1, SHADER::FLOOR);
	FLOOR_EXT_DINING1			= ResourceHandler::RegisterMaterial(TEXTURE::FLOOR_EXT_DINING1, SHADER::FLOOR);
	FLOOR_EXT_CABOOSE1			= ResourceHandler::RegisterMaterial(TEXTURE::FLOOR_EXT_CABOOSE1, SHADER::FLOOR);
}