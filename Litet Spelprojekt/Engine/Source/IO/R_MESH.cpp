...
uint32 MESH::ANIMATED_MODEL_EXTINGUISH = 0;
uint32 MESH::ANIMATED_MODEL_EXTINGUISH_RUN = 0;
uint32 MESH::ANIMATED_MODEL_WALK = 0;
...
void MESH::RegisterResourcesPreLoading()
{
	...
	SHIP					= ResourceHandler::RegisterMesh("ship2.obj");
}
...
void MESH::RegisterResources()
{
	...
	ANIMATED_MODEL_EXTINGUISH		= ResourceHandler::RegisterAnimatedMesh("CrewMemberExting1.fbx");
	ANIMATED_MODEL_EXTINGUISH_RUN	= ResourceHandler::RegisterAnimatedMesh("CrewMemberExtingRunning1.fbx");
	ANIMATED_MODEL_WALK				= ResourceHandler::RegisterAnimatedMesh("CrewMemberWalk1.fbx");
