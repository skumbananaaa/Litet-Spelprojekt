...
public:
	...
	virtual void OnVisibilityChange(World* pWorld, SceneGame* pScene, const std::vector<uint32>& activeRooms) = 0;
	virtual bool Update(float dtS, World* pWorld, SceneGame* pScene, const std::vector<uint32>& activeRooms) noexcept = 0;
