...
void ScenarioManager::OnVisibilityChange(World* pWorld, SceneGame* pScene, const std::vector<uint32>& activeRooms) noexcept
{
...
void ScenarioManager::Update(float dtS, World* world, SceneGame* scene, const std::vector<uint32>& activeRooms) noexcept
{
