...
void ScenarioWater::OnVisibilityChange(World* pWorld, SceneGame* pScene, const std::vector<uint32>& activeRooms)
{
...
bool ScenarioWater::Update(float dtS, World* pWorld, SceneGame* pScene, const std::vector<uint32>& activeRooms) noexcept
{
#if defined(PRINT_CPU_DEBUG_DATA)
